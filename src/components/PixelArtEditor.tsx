...
const COLOR_PALETTE = [
  ...
  "#1a3300", "#336600", "#4d9900", "#66cc00", "#80ff00", "#99ff33", "#b3ff66", "#ccff99", "#e6ffcc",
  // Row 6 - Greens
  ...
  // Row 9 - Purples
  "#1a0033", "#330066", "#4d0099", "#6600cc", "#8000ff", "#9933ff", "#b366ff", "#cc99ff", "#e6ccff",
  // Row 10 - Magentas
  "#330033", "#660066", "#990099", "#cc00cc", "#ff00ff", "#ff33ff", "#ff66ff", "#ff99ff", "#ffccff",
  // Row 11 - Pinks
  "#330019", "#660033", "#99004d", "#cc0066", "#ff0080", "#ff3399", "#ff66b3", "#ff99cc", "#ffcce6",
  // Row 12 - Browns & Earth tones
  "#1a0f00", "#332200", "#4d3300", "#664400", "#805500", "#996633", "#b38d4d", "#ccb366", "#e6d9b3",
  // Row 13 - Skin tones
  "#8d5524", "#c68642", "#e0ac69", "#f1c27d", "#ffdbac", "#ffe0bd", "#ffecd1",
];
...
export function PixelArtEditor({ isOpen, onClose, onSend, isSending }: PixelArtEditorProps) {
  ...
  // Clear canvas
  const handleClear = () => {
    setPixels(Array(CANVAS_SIZE).fill(null).map(() => Array(CANVAS_SIZE).fill("#ffffff")));
  };
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between mb-4">
              <div>
                <h2 className="text-xl font-semibold text-white">Pixel Art</h2>
                <p className="text-zinc-500 text-sm">Create a 32×32 masterpiece</p>
              </div>
              <button
                onClick={onClose}
            ...
            <div className="flex justify-center mb-4">
              <div className="border-2 border-zinc-700 rounded-lg overflow-hidden" style={{ touchAction: "none" }}>
                <canvas
                  ref={canvasRef}
                  width={CANVAS_SIZE * PIXEL_SIZE}
                  height={CANVAS_SIZE * PIXEL_SIZE}
                  className="cursor-crosshair"
                  style={{ width: "100%", maxWidth: CANVAS_SIZE * PIXEL_SIZE, imageRendering: "pixelated" }}
            ...
            <div className="flex items-center justify-center gap-2 mb-4">
              <button
                ...
                className={`p-2.5 rounded-lg transition-colors ${tool === "draw" ? "bg-violet-600 text-white" : "bg-zinc-800 text-zinc-400 hover:text-white"}`}
                title="Draw"
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5">
              ...
              <button
                ...
                className={`p-2.5 rounded-lg transition-colors ${tool === "erase" ? "bg-violet-600 text-white" : "bg-zinc-800 text-zinc-400 hover:text-white"}`}
                title="Erase"
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5">
              ...
              <button
                ...
                className={`p-2.5 rounded-lg transition-colors ${tool === "fill" ? "bg-violet-600 text-white" : "bg-zinc-800 text-zinc-400 hover:text-white"}`}
                title="Fill"
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5">
                ...
                >
                  <div className="flex items-center gap-2 p-3 bg-zinc-800 rounded-lg">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 bg-violet-600 hover:bg-violet-500 text-white text-sm rounded transition-colors"
                    >
                      Use
                    </button>
                  </div>
            ...
            <div className="grid grid-cols-11 gap-1 mb-4 p-2 bg-zinc-800 rounded-lg max-h-32 overflow-y-auto">
              {COLOR_PALETTE.map((color, index) => (
                <button
                  ...
                  className={`w-6 h-6 rounded transition-transform hover:scale-110 ${selectedColor === color ? "ring-2 ring-white ring-offset-1 ring-offset-zinc-800" : ""}`}
