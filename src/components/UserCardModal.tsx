    ...
    return (
        <AnimatePresence>
            ...
            <motion.div
                ...
                aria-hidden
            />
            {/* Panel: full width on mobile, centered max-w on desktop (similar to other tabs) */}
            <motion.div
                initial={{ opacity: 0, scale: 0.98 }}
                animate={{ opacity: 1, scale: 1 }}
                exit={{ opacity: 0, scale: 0.98 }}
                transition={{ type: "tween", duration: 0.2 }}
                className="fixed inset-0 z-[101] md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:w-full md:max-w-md md:max-h-[90vh] md:rounded-2xl md:border md:border-zinc-800 md:shadow-2xl bg-zinc-950 flex flex-col safe-area-inset overflow-hidden"
