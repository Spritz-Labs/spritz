...
export function PollCreator({ isOpen, onClose, onCreatePoll }: PollCreatorProps) {
    ...
    const [duration, setDuration] = useState<"none" | "1h" | "24h" | "7d">("none");
                        ...
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-zinc-500 text-sm">Ask the community</p>
                                </div>
                            </div>
                            <button
                                onClick={handleClose}
                            ...
                            <div className="space-y-3 pt-2 border-t border-zinc-800">
                                <label className="flex items-center justify-between cursor-pointer">
                                    ...
                                    <button
                                        ...
                                        className={`w-11 h-6 rounded-full transition-colors ${
                                            allowsMultiple ? "bg-purple-500" : "bg-zinc-700"
                                        }`}
                                    >
                                        <div className={`w-5 h-5 rounded-full bg-white transition-transform ${
                                            allowsMultiple ? "translate-x-5" : "translate-x-0.5"
                                        }`} />
                                    </button>
                                </label>
                                ...
                                <label className="flex items-center justify-between cursor-pointer">
                                    ...
                                    <button
                                        ...
                                        disabled={isSubmitting}
                                        className={`w-11 h-6 rounded-full transition-colors ${
                                            isAnonymous ? "bg-purple-500" : "bg-zinc-700"
                                        }`}
                                    >
                                        <div className={`w-5 h-5 rounded-full bg-white transition-transform ${
                                ...
                                <div>
                                    <label className="block text-sm text-zinc-300 mb-2">Poll Duration</label>
