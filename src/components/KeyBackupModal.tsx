    ...
    const handleRestore = async () => {
        ...
        try {
            ...
            const decrypted = await decryptWithDerivedKey(
                data.messaging_backup_encrypted,
                derived.key
            );
            if (!decrypted) {
                ...
                >
                    ...
                    <div className="p-4">
                        ...
                        {step === "choice" && (
                            <div className="space-y-4">
                                <p className="text-zinc-400 text-sm">
                                    Choose how to manage your message encryption keys. Keys are
                                    stored locally by default for maximum security.
                                </p>
                                ...
                                {backupEnabled ? (
                                    <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-4">
                                        ...
                                        <p className="text-zinc-400 text-sm">
                                            Your keys are backed up and can be restored on new
                                            devices.
                                        </p>
                                        <button
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-zinc-500 text-sm">
                                                        Restore on new devices with phrase + PIN
                                                    </p>
                                                </div>
                                            </div>
                                        </button>
                                ...
                                <div className="bg-zinc-800/50 rounded-lg p-3 mt-4">
                                    <p className="text-zinc-500 text-xs">
                                        <strong className="text-zinc-400">Local Only Mode:</strong>{" "}
                                        Without backup, your encryption keys exist only on this
                                        device. If you lose access, messages cannot be recovered.
                                    </p>
                                </div>
                            </div>
                        )}
                        ...
                        {step === "pin" && (
                            <div className="space-y-4">
                                <p className="text-zinc-400 text-sm">
                                    Create a 6-digit PIN to protect your backup. You&apos;ll need
                                    this PIN along with your recovery phrase to restore.
                                </p>
                            ...
                            <div className="space-y-4">
                                <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-3">
                                    <p className="text-amber-400 text-sm">
                                        <strong>Write these words down!</strong> You&apos;ll need
                                        them to restore your messages. Never share them with anyone.
                                    </p>
                                </div>
                                ...
                                <div className="bg-zinc-800 rounded-xl p-4">
                                    <div className="grid grid-cols-3 gap-2">
                                        {phrase.split(" ").map((word, i) => (
                                            <div
                                                key={i}
                                                className="flex items-center gap-2 bg-zinc-700/50 rounded-lg p-2"
                                            >
                                                <span className="text-zinc-500 text-xs w-4">
                                                    {i + 1}.
                                                </span>
                        ...
                        {step === "verify" && (
                            <div className="space-y-4">
                                <p className="text-zinc-400 text-sm">
                                    Tap the correct words from your recovery phrase to verify
                                    you&apos;ve saved it.
                                </p>
                                ...
                                <div className="flex items-center justify-center gap-2">
                                    {verifyIndices.map((idx, i) => (
                                        <div key={idx} className="flex items-center gap-2">
                                            ...
                                            {i < 2 && (
                                                <div
                                                    className={`w-8 h-0.5 ${verifyInputs[i] ? "bg-green-500" : "bg-zinc-700"}`}
                                                />
                                            )}
                                        </div>
                                    ))}
                                ...
                                <div className="bg-zinc-800/50 rounded-xl p-4 text-center">
                                    ...
                                    <p className="text-white text-2xl font-bold">
                                        #{verifyIndices[currentVerifyIndex]}
                                    </p>
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                    {shuffledWords.map((word, i) => {
                                        ...
                                        const isCurrentSelection =
                                            verifyInputs[currentVerifyIndex] === word;
                                        return (
                                            <button
                                                key={`${word}-${i}`}
                                                onClick={() =>
                                                    !isSelected && handleWordSelect(word)
                                                }
                        ...
                        {step === "complete" && (
                            <div className="text-center py-8">
                                ...
                                <p className="text-zinc-400 text-sm mb-6">
                                    Your encryption keys are now backed up. You can restore them on
                                    any device using your recovery phrase and PIN.
                                </p>
                                <button
                                    onClick={onClose}
                        ...
                        {step === "restore" && (
                            <div className="space-y-4">
                                {restoreSuccess ? (
                                    ...
                                    <>
                                        <p className="text-zinc-400 text-sm">
                                            Enter your 12-word recovery phrase and 6-digit PIN to
