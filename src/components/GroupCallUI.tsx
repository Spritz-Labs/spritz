...
export function GroupCallUI({
  ...
  }, [setLocalVideoContainer, setRemoteVideoContainer, setScreenShareContainer]);
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent">
        <div className="flex items-center justify-center gap-3">
          ...
          <button
            ...
            className={`w-12 h-12 sm:w-14 sm:h-14 rounded-full flex items-center justify-center transition-colors ${
              isScreenSharing ? "bg-emerald-500 text-white" : "bg-zinc-800 text-white hover:bg-zinc-700"
            }`}
