...
export function AlphaChatModal({
    ...
    const solanaSnsForSenders = useSolanaDisplayLabelMap(alphaSenderAddressesForSns);
    ...
    const { polls, canCreatePoll, fetchPolls, createPoll, vote, updatePoll, deletePoll } =
    ...
    const [hiddenPollIds, setHiddenPollIds] = useState<string[]>(() => {
        ...
        try {
            return JSON.parse(window.localStorage.getItem(HIDDEN_POLLS_KEY) ?? "[]");
        } catch {
            return [];
        }
    });
    ...
    const handleDeleteMessage = async (messageId: string) => {
        ...
        const isOwnMessage =
            targetMsg?.sender_address?.toLowerCase() === userAddress?.toLowerCase();
    ...
    const handleSendGif = useCallback(
        async (gifUrl: string) => {
            ...
            try {
                ...
                reportError(err, { context: "alphaChatSendGIF", silent: true });
            }
        },
    ...
    const handleSendPixelArt = useCallback(
        async (imageData: string) => {
            ...
            try {
                ...
                reportError(err, { context: "alphaChatPixelArt", silent: true });
            } finally {
    ...
    const handleImageSelect = useCallback(
        async (e: React.ChangeEvent<HTMLInputElement>) => {
            ...
            try {
                ...
                reportError(error, { context: "alphaChatImageUpload", silent: true });
    ...
    const isImageMessage = (content: string) =>
        content.startsWith("[IMAGE]") || content.includes("/storage/v1/object/public/chat-images/");
                        ...
                        >
                                ...
                                <div className="flex-1 flex items-center justify-center p-8">
                                    <div className="text-center">
                                        ...
                                        <p className="text-zinc-400 text-sm mb-6 max-w-xs">
                                            Connect with the Spritz community! Get updates, share
                                            ideas, and meet other users.
                                        </p>
                                        <button
                                            onClick={handleJoin}
                                            disabled={isJoining}
                            ...
                            {isMember && (
                                <>
                                    ...
                                    {/* Room Rules Banner */}
                                    <ChatRulesBanner chatType="alpha" chatId={null} />
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <ChatAttachmentMenu
                                                ...
                                                chatRules={chatRules}
                                                isModerator={
                                                    isAdmin || moderation.permissions.isModerator
                                                }
                                            />
                                            {isCurrentUserMuted ? (
                                                <div
                                            ...
                                            selectedUser.toLowerCase() !==
                                                ...
                                                <button
                                                    onClick={async () => {
                                                        ...
                                                        await roomBans.banUser(selectedUser, {
                    ...
                    <MessageActionBar
                        ...
                        callbacks={{
                            ...
                            onUnpin: selectedMessageConfig?.isPinned
                                ...
                                : undefined,
                            onDelete:
                                selectedMessageConfig?.isOwn || moderation.permissions.canDelete
                                    ? () =>
                                          handleDeleteMessage(
                                              selectedMessageConfig?.messageId || ""
                                          )
