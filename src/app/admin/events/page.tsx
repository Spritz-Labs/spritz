                    ...
                    {showScrapeModal && (
                        ...
                        >
                            ...
                            >
                                ...
                                <form id="scrape-form" onSubmit={handleScrape} className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4 sm:space-y-5">
                                    {/* URL Input */}
                                    <div>
                                ...
                                <div className="sticky bottom-0 bg-gradient-to-t from-zinc-950 via-zinc-950 to-transparent pt-4 pb-2 sm:pb-4 px-4 sm:px-6 border-t border-zinc-800 shrink-0">
                                    <div className="flex justify-between items-center gap-2 sm:gap-3">
                                        ...
                                        >
                                            ...
                                            <span className="hidden sm:inline">View {eventSources.length} Saved Source{eventSources.length !== 1 ? "s" : ""}</span>
                                        ...
                                        {scrapeStatus === "preview" ? (
                                            <div className="flex gap-2 sm:gap-3">
                                                ...
                                                >
                                                    ...
                                                    <span className="hidden sm:inline">Save {selectedPreviewEvents.size} Events</span>
                                                ...
                                                <>
                                                    ...
                                                    <span className="hidden sm:inline">Scraping...</span>
                                                        ...
                                                        <>
                                                            ...
                                                            <span className="hidden sm:inline">Scrape & Save</span>
