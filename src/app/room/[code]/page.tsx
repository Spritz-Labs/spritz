                    ...
                    >
                        {hasAnyScreenShare ? (
                            ...
                            >
                                ...
                                <div className="relative bg-zinc-900 rounded-2xl overflow-hidden flex items-center justify-center min-h-0 min-w-0">
                                    {isScreenSharing ? (
                                        <video
                                            ref={localScreenShareRef}
                                            autoPlay
                                ...
                                <AnimatePresence>
                                    {remotePeerArray.map((peer) => (
                                        <motion.div
                                            ...
                                            className="relative bg-zinc-900 rounded-2xl overflow-hidden flex items-center justify-center min-h-0 min-w-0"
                                        >
