...
async function canManageAlphaPolls(userAddress: string): Promise<boolean> {
...
// PATCH /api/alpha/polls/[pollId] - Update poll (admin/moderator)
...
// DELETE /api/alpha/polls/[pollId] - Delete poll (admin/moderator)
